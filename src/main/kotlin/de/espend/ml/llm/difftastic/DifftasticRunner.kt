...
object DifftasticRunner {
    ...
    fun run(
        ...
        commandPath: String? = configuredCommandPath(),
    ...
    private fun configuredCommandPath(): String? =
        runCatching { StructuralDiffSettings.instance.executableFor("difftastic") }.getOrNull()
            ?: CommandPathUtils.findDifftasticPath()
}
